        ...
        child: Stack(
          children: [
            Container(
              ...
              child: Column(
                children: [
                  Image.asset(AssetsHelper.pan,height: AHelperFunction.screenSize(context).height * .24),
                  Image.asset(AssetsHelper.logo,height: AHelperFunction.screenSize(context).height * .09),
                ],
              ),
            ),
            Positioned(
              ...
              left: 0,right: 0,
              child: Container(
                margin: EdgeInsets.symmetric(horizontal: DimensionHelper.dimens_40.sp),
